...
$pdf->Ln(6);
$pdf->Cell(0,0,'No. '.$awal['NO_FORM'], 0, 0, 'C', false);	
...
$pdf->Cell(5,0,':', 0, 0, 'C', false);	
$pdf->Cell(0,0,$status_kk_pindah[0], 0, 0, 'L', false);	
$pdf->Ln(5);
$pdf->Cell(5,0,'', 0, 0, 'C', false);	
...
$pdf->Cell(5,0,':', 0, 0, 'C', false);	
$pdf->Cell(0,0,$tujuan['nik_kepkel_tujuan'], 0, 0, 'L', false);	
$pdf->Ln(5);
...
$pdf->Cell(50,0,'Nama Kepala Keluarga', 0, 0, 'L', false);	
$pdf->Cell(5,0,':', 0, 0, 'C', false);	
$pdf->Cell(0,0,$tujuan['nama_lgkp'], 0, 0, 'L', false);	
$pdf->Ln(5);
...
FROM datang_detail a , biodata_wni b
WHERE a.nik_pemohon = b.nik AND a.id_datang='$id' ";
...
$pdf->Cell(20,0,'', 0, 0, 'C', false);	
$pdf->Cell(70,0,'Lurah', 0, 0, 'C', false);	
$pdf->Cell(5,0,'', 0, 0, 'C', false);	
