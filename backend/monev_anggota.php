               ...
               <tbody>
                ...
                ?>
                    <tr>
                        ...
                        $barang = mysqli_query($con,"SELECT COUNT(b.nik_pemohon) AS pemohon FROM datang_header b , biodata_wni c WHERE b.nik_kepkel_tujuan=c.nik AND c.no_prop='35' AND c.no_kab='78' AND c.no_kec='$kdbarang'");
                        ...
                        $garang = mysqli_query($con,"SELECT COUNT(d.nik_pemohon) AS pemohon FROM datang_header b , biodata_wni c , datang_detail d WHERE b.nik_kepkel_tujuan=c.nik AND c.no_prop='35' AND c.no_kab='78' AND d.id_datang=b.id AND c.no_kec='$idbarang'");
