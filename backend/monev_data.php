        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">monev data</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <tbody>
                <?php
                $no = 1;
                $sql = "SELECT a.nik , a.nama_lgkp , a.alamat , b.created_at , b.tgl_app , b.flag_status , b.id     FROM biodata_wni a , datang_header b WHERE a.nik=b.nik_kepkel_tujuan and b.is_delete != '1' and a.no_kec = '$kode' AND a.no_prop='35' AND a.no_kab='78'";
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="form_pemohon.php?nik=<?php echo $data['nik'] ?>"><span class="badge btn-success">edit</span></a>
                            ...
                            <a href="index.php?page=edit&id=2"><span class="badge btn-info">note</span></a>
