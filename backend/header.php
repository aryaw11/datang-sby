      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="list_datang.php">Pindah Datang</a></li>
            <li><a href="../backend_keluar/list_datang.php">Pindah Keluar</a></li>
            <?php if ($_SESSION['role']=='kec') { } else {?>
            <li><a href="manajemen_user.php">Manajemen user</a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">monev <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="monev_anggota.php">Pindah Datang</a></li>
                <li><a href="../backend_keluar/monev_anggota.php">Pindah Keluar</a></li>
              </ul>
            </li>
            <?php } ?>
