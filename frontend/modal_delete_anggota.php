<?php
    ...
    $barang = mysqli_query($con,"select nik_pemohon,id_datang,id from datang_detail where id='$kdbarang'");
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">NIK</label>
                                    <div class="col-lg-5">
                                        ...
                                        <input style="width: 200px;"  class="form-control" type="hidden" name="id_datang" value="<?php echo $row['id_datang']; ?>" />
