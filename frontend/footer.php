...
<script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            function cek_status(){
                var itemNik = $("#itemNik").val();
                $.ajax({
                    url: 'api/cek_data_status.php',
                    data:"itemNik="+itemNik ,
                }).success(function (data) {
                    var json = data,
                    obj = JSON.parse(json);
                     
                    $('#namapemohon').val(obj.nama_lgkp);
                    $('#noform').val(obj.no_form);
                    $('#nskp').val(obj.swni);
                    $('#email').val(obj.email);
                    $('#niktujuan').val(obj.nik_tujuan);
                    $('#namatujuan').val(obj.nama_lgkp_tujuan);
                    $('#alamattujuan').val(obj.alamat);
