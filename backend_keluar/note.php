...
?>
        ...
        <div class="col-md-12">
          ...
          <ul class="timeline">
<?php 
    $qr = mysqli_query($con," SELECT a.catatan ,a.created_at,(SELECT b.user FROM users b WHERE b.uid=a.id_user ) as user FROM note a WHERE a.id_datang = '$kdbarang' and a.jenis='2' order by a.created_at desc");
