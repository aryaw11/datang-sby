...
$id=$_GET['id'];
	...
	b.alamat ,  a.email_pemohon , a. telp_pemohon , b.no_rt , b.no_rw , b.no_kk , a.no_form , a.alamat as tujuan
...
<body>
<p style="text-align: right;">F.1-33</p>
...
?>
<p style="text-align: right;">Surabaya, <?php echo ShowDate(date('y-m-d'),5) ?> <br>Kepala Desa/Lurah</p>
<p style="text-align: right;">&nbsp;</p>
<p style="text-align: right;">&nbsp;</p>
<p style="text-align: right;">_________________________</p>
<p>Keterangan :</p>
<p>Surat Pengantar ini dibawa oleh pemohon dan diarsipkan di Kecamatan.</p>
<script>
