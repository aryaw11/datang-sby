            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <tbody>
                <?php
                $no = 1;
                $sql = "SELECT a.nik , a.nama_lgkp , a.alamat , b.created_at , b.tgl_app , b.flag_status , b.id     FROM biodata_wni a , keluar_header b WHERE a.nik=b.nik_pemohon and b.is_delete != '1' and a.no_kec = '$kode' AND a.no_prop='35' AND a.no_kab='78'";
