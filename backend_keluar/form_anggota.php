...
$nikpemohon = $_GET['nik'];
$c=mysqli_fetch_array(mysqli_query($con,"SELECT id from keluar_header where NIK_PEMOHON =  '$nikpemohon' "));
  $id_keluar = $c['id'];
if(isset($_POST['NikAng'])) { 
  ...
  $qq="insert into keluar_detail (ID_KELUAR,NIK_PEMOHON,SHDK) values ('$id_keluar','$NikAng','$shdk')";
            ...
            <!-- /.box-footer -->
              ...
              <table class="table" id="subtable">
                ...
                <tbody>
                     <?php
                                $no = 1;
                                $sqlbarang = mysqli_query($con,"SELECT a.id,a.nik_pemohon , b. nama_lgkp , (SELECT c.nama FROM reff_master c WHERE c.id=a.shdk) AS shdk FROM keluar_detail a , biodata_wni b WHERE a.nik_pemohon = b.nik AND a.id_keluar = '$id_keluar'");
