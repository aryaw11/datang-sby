            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <tbody>
                <?php
                $no = 1;
                $sql = "SELECT a.nik , a.nama_lgkp , a.alamat , b.created_at , b.tgl_app , b.flag_status , b.id     FROM biodata_wni a , keluar_header b WHERE a.nik=b.nik_pemohon and b.is_delete != '1'";
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="form_pemohon.php?nik=<?php echo $data['nik'] ?>"><span class="badge btn-success">edit</span></a>
                        ...
                        <td><a target="_blank" href="f133.php?id=<?php echo $data['id'] ?>"><span class="badge btn-success">F.1-33</span></a>
                            <a target="_blank" href="f134.php?id=<?php echo $data['id'] ?>"><span class="badge btn-primary">F.1-34</span></a>
                            <a target="_blank" href="f135.php?id=<?php echo $data['id'] ?>"><span class="badge btn-danger">F.1-35</span></a>
                            <a target="_blank" href="f136.php?id=<?php echo $data['id'] ?>"><span class="badge btn-warning">F.1-36</span></a>
                            <a target="_blank" href="f137.php?id=<?php echo $data['id'] ?>"><span class="badge btn-info">F.1-37</span></a>
                        </td>
                    </tr>
                    <?php
                                $no++;
